...
+ (int)getEnumValue:(nonnull NSString *)key {
    ...
    dispatch_once(&predicate, ^{
      methodMap = @{
          ...
          /// CircleManager
          MKcreateCircleServer : @(MKcreateCircleServerValue),
          MKdestroyCircleServer : @(MKdestroyCircleServerValue),
          MKupdateCircleServer : @(MKupdateCircleServerValue),
          MKjoinCircleServer : @(MKjoinCircleServerValue),
          MKleaveCircleServer : @(MKleaveCircleServerValue),
          MKremoveUserFromCircleServer : @(MKremoveUserFromCircleServerValue),
          MKinviteUserToCircleServer : @(MKinviteUserToCircleServerValue),
          MKacceptCircleServerInvitation : @(MKacceptCircleServerInvitationValue),
          MKdeclineCircleServerInvitation : @(MKdeclineCircleServerInvitationValue),
          MKaddTagsToCircleServer : @(MKaddTagsToCircleServerValue),
          MKremoveTagsFromCircleServer : @(MKremoveTagsFromCircleServerValue),
          MKfetchCircleServerTags : @(MKfetchCircleServerTagsValue),
          MKaddModeratorToCircleServer : @(MKaddModeratorToCircleServerValue),
          MKremoveModeratorFromCircleServer : @(MKremoveModeratorFromCircleServerValue),
          MKfetchSelfCircleServerRole : @(MKfetchSelfCircleServerRoleValue),
          MKfetchJoinedCircleServers : @(MKfetchJoinedCircleServersValue),
          MKfetchCircleServerDetail : @(MKfetchCircleServerDetailValue),
          MKfetchCircleServersWithKeyword : @(MKfetchCircleServersWithKeywordValue),
          MKfetchCircleServerMembers : @(MKfetchCircleServerMembersValue),
          MKcheckSelfInCircleServer : @(MKcheckSelfInCircleServerValue),
          MKcreateCircleChannel : @(MKcreateCircleChannelValue),
          MKdestroyCircleChannel : @(MKdestroyCircleChannelValue),
          MKupdateCircleChannel : @(MKupdateCircleChannelValue),
          MKjoinCircleChannel : @(MKjoinCircleChannelValue),
          MKleaveCircleChannel : @(MKleaveCircleChannelValue),
          MKremoveUserFromCircleChannel : @(MKremoveUserFromCircleChannelValue),
          MKinviteUserToCircleChannel : @(MKinviteUserToCircleChannelValue),
          MKacceptCircleChannelInvitation : @(MKacceptCircleChannelInvitationValue),
          MKdeclineCircleChannelInvitation : @(MKdeclineCircleChannelInvitationValue),
          MKmuteUserInCircleChannel : @(MKmuteUserInCircleChannelValue),
          MKunmuteUserInCircleChannel : @(MKunmuteUserInCircleChannelValue),
          MKfetchCircleChannelDetail : @(MKfetchCircleChannelDetailValue),
          MKfetchPublicCircleChannelInServer : @(MKfetchPublicCircleChannelInServerValue),
          MKfetchCircleChannelMembers : @(MKfetchCircleChannelMembersValue),
          MKfetchVisiblePrivateCircleChannelInServer : @(MKfetchVisiblePrivateCircleChannelInServerValue),
          MKcheckSelfIsInCircleChannel : @(MKcheckSelfIsInCircleChannelValue),
          MKfetchCircleChannelMuteUsers : @(MKfetchCircleChannelMuteUsersValue),

          /// CircleManager listener
          MKonCircleServerDestroyed : @(MKonCircleServerDestroyedValue),
          MKonCircleServerUpdated : @(MKonCircleServerUpdatedValue),
          MKonMemberJoinedCircleServer : @(MKonMemberJoinedCircleServerValue),
          MKonMemberLeftCircleServer : @(MKonMemberLeftCircleServerValue),
          MKonMemberRemovedFromCircleServer : @(MKonMemberRemovedFromCircleServerValue),
          MKonReceiveInvitationFromCircleServer : @(MKonReceiveInvitationFromCircleServerValue),
          MKonInvitationBeAcceptedFromCircleServer : @(MKonInvitationBeAcceptedFromCircleServerValue),
          MKonInvitationBeDeclinedFromCircleServer : @(MKonInvitationBeDeclinedFromCircleServerValue),
          MKonRoleAssignedFromCircleServer : @(MKonRoleAssignedFromCircleServerValue),

          MKonCircleChannelCreated : @(MKonCircleChannelCreatedValue),
          MKonCircleChannelDestroyed : @(MKonCircleChannelDestroyedValue),
          MKonCircleChannelUpdated : @(MKonCircleChannelUpdatedValue),
          MKonMemberJoinedCircleChannel : @(MKonMemberJoinedCircleChannelValue),
          MKonReceiveInvitationFromCircleChannel : @(MKonReceiveInvitationFromCircleChannelValue),
          MKonInvitationBeAcceptedFromCircleChannel : @(MKonInvitationBeAcceptedFromCircleChannelValue),
          MKonInvitationBeDeclinedFromCircleChannel : @(MKonInvitationBeDeclinedFromCircleChannelValue),
          MKonMemberRemovedFromCircleChannel : @(MKonMemberRemovedFromCircleChannelValue),
          MKonMemberLeftCircleChannel : @(MKonMemberLeftCircleChannelValue),
          MKonMemberMuteChangedInCircleChannel : @(MKonMemberMuteChangedInCircleChannelValue),
      };
    });
    if (nil != key) {
